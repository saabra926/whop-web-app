...
import { createSdk } from "@whop/react";

let whop: ReturnType<typeof createSdk> | null = null;
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        {email ? (
          ...
          <div className="bg-yellow-100 border border-yellow-300 text-yellow-800 rounded-lg p-4 mb-6 text-center">
            ⚠️ You’re not logged in. Please sign in to personalize your experience.
          </div>
        )}

        {/* Existing Showcase Title */}
